...
203   format (/,' Eigenvectors')
       ...
       if(n.eq.1 .and. i.eq.201)  write (*,*) 'rmat(1,3,i)',rmat(1,2,i)
       if(n.eq.1 .and. i.eq.201)  write (*,*) 'rmat(2,3,i)',rmat(2,2,i)
       if(n.eq.1 .and. i.eq.201)  write (*,*) 'rmat(3,3,i)',rmat(3,2,i)
