...
c========================================================================
     ...
     &               ,ermat(3,3,-2000:2000)
      ...
      INTEGER          ierr,i1,j1
      Integer          iv1(n1)
      DOUBLE PRECISION ab( nm1, n1 ), wr(n1), wi(n1),z( nm1, n1 ),fv1(n)
...
c      if(n.eq.1 .and. i.eq.201)  write (*,200)
      ...
      call rg(nm1,n1,ab,wr,wi,matz,z,iv1,fv1,ierr)

      if(n.eq.1 .and. i.eq.201)  WRITE(*,*)  "*********"

      DO i1 = 1, n1
       DO j1 = 1, n1
          if(n.eq.1 .and. i.eq.201)  WRITE(*,*)  ab( i1, j1 ) 
       END DO
      END DO
      ...
      DO i1 = 1, n1
       DO j1 = 1, n1
          if(n.eq.1 .and. i.eq.201)  WRITE(*,*)  z( i1, j1 ) 
       END DO
      END DO
      ...
      if(n.eq.1 .and. i.eq.201)  WRITE(*,*)  "*****Wr****"
       ...
       DO i1 = 1, n1
          if(n.eq.1 .and. i.eq.201)  WRITE(*,*)  wr( i1 ) 
       END DO

      if(n.eq.1 .and. i.eq.201)  WRITE(*,*)  "*****Wi****"

       DO i1 = 1, n1
          if(n.eq.1 .and. i.eq.201)  WRITE(*,*)  wi( i1 ) 
       END DO

      if(n.eq.1 .and. i.eq.201)  WRITE(*,*)  "*********"

      if(n.eq.1 .and. i.eq.201)  WRITE(*,*) ierr
